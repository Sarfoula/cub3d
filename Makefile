...
SRC            :=	debug/print_textures.c debug/print_map.c debug/print_xpm_infos.c debug/print_xpm_rgb.c\
					...
					utils/identificator.c utils/identificator_cardinal.c utils/isspace.c utils/line_empty.c utils/remove_backslash_n.c utils/ft_strstr.c utils/countchar.c utils/map_utils.c utils/ft_atoi_base.c\
